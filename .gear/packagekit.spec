...
%changelog
* Wed Jan 22 2025 Ivan Zakharyaschev <imz@altlinux.org> 1.2.5.0.0.35-alt1
- Tiny enhancements to the source code driven by compiler warnings.
  (Thx Dmitrii Fomchenkov sirius@ for a fix.)
